...
assert.match(extensionSource, /hunt started/, "Autopilot should log hunt started");
assert.match(extensionSource, /scan tick/, "Autopilot should log scan tick");
assert.match(extensionSource, /score decision/, "Autopilot should log score decisions");
assert.match(extensionSource, /import success/, "Autopilot should log import success");
