  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 leading-7 text-slate-700">
        MarketVibe helps agencies, consultants, and growth teams review public buyer-intent signals, prioritize opportunities, and decide which markets are worth more time.
      </p>
      <p className="mt-4 leading-7 text-slate-700">
