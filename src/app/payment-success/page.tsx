  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="rounded-lg border border-emerald-200 bg-white p-8 text-center shadow-sm">
        ...
        <h1 className="mt-5 text-3xl font-semibold text-slate-950">Payment received</h1>
        <p className="mx-auto mt-3 max-w-2xl text-slate-600">
          Your MarketVibe access is ready. Open the workspace, browse lead packs, or run a new search.
        </p>
