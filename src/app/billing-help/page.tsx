  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 grid gap-4 leading-7 text-slate-600">
        ...
        <p>Proof Pack is a one-off digital purchase. Radar and Growth Desk are monthly subscriptions. Cancellation stops future renewals according to your Stripe subscription status and paid access period.</p>
