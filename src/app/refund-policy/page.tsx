  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mt-4 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 leading-7 text-slate-700">Starter and Pro are monthly subscriptions handled through Stripe. Contact support for billing or cancellation questions.</p>
      </section>
      <section className="mt-4 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
