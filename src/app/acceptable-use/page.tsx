  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 grid gap-4 leading-7 text-slate-600">
        <p>Use MarketVibe1 outputs for lawful research, prioritization, and outreach planning. Review source context before contacting anyone.</p>
        <p>Do not use MarketVibe1 to send deceptive, abusive, unlawful, or spam-like outreach. Do not claim guaranteed revenue, buying urgency, budget, authority, or private facts unless your own verified source supports it.</p>
